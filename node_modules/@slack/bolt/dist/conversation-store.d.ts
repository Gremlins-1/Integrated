import { Middleware, AnyMiddlewareArgs } from '@slack/bolt/dist/types';
 ...
 */
export declare function conversationContext<ConversationState = any>(store: ConversationStore<ConversationState>, logger: Logger): Middleware<AnyMiddlewareArgs>;
