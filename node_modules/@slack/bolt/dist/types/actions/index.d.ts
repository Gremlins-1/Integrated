export * from '@slack/bolt/dist/types/actions/block-action';
export * from '@slack/bolt/dist/types/actions/interactive-message';
export * from '@slack/bolt/dist/types/actions/dialog-action';
export * from '@slack/bolt/dist/types/actions/message-action';
import { BlockAction } from '@slack/bolt/dist/types/actions/block-action';
import { InteractiveMessage } from '@slack/bolt/dist/types/actions/interactive-message';
import { DialogSubmitAction, DialogValidation } from '@slack/bolt/dist/types/actions/dialog-action';
import { MessageAction } from '@slack/bolt/dist/types/actions/message-action';
import { SayFn, SayArguments, RespondFn, AckFn } from '@slack/bolt/dist/types/utilities';
/**
 ...
 */
export declare type SlackAction = BlockAction | InteractiveMessage | DialogSubmitAction | MessageAction;
/**
